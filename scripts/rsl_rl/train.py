...
if version.parse(installed_version) < version.parse(RSL_RL_VERSION):
    # note: this project is launched directly from a Python venv where isaaclab is pip-installed,
    # so we point the user at plain pip rather than the isaaclab.sh/bat wrapper.
