...
$$q = (q_1, q_2, q_3, q_4) \in \mathbb{R}^4,\qquad q = [\text{front\_left\_thigh},\; \text{front\_right\_thigh},\; \text{rl\_wheel},\; \text{rr\_wheel}].$$
